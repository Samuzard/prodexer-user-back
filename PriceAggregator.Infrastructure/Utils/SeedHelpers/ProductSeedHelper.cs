        ...
        modelBuilder.Entity<Product>()
            .HasData(new Product
                ...
                new Product
                {
                    ...
                    StoreId = 2,
                    Url =
                        "https://www.stirlingsports.co.nz/mens/clothing/tees-and-singlets/IL5172/Adventure-Volcano-Long-Sleeve-Tee.html",
                    Price = 100.00M,
                    PriceUnit = "$",
                    CategoryId = 5
                },
                new Product
                {
                    ...
                    StoreId = 1,
                    Url =
                        "https://www.amazon.com/Volcano-Adventure-Climate-Premium-T-Shirt/dp/B0BH88FLPM?customId=B0753883B1&customizationToken=MC_Assembly_1%23B0753883B1&th=1",
                    Price = 70.00M,
                    PriceUnit = "$",
                    CategoryId = 6
                }, new Product
                {
                    ...
                    StoreId = 1,
                    Url =
                        "https://www.amazon.com/GIGABYTE-G5-1920x1080-i5-12500H-KF-E3US333SH/dp/B0BVRGF3MR/ref=sr_1_8?keywords=gigabyte&qid=1694092757&s=pc&sprefix=gigabyte%2Caps%2C190&sr=1-8",
                    Price = 879.00M,
                    PriceUnit = "$",
                    CategoryId = 7
                },
                ...
                new Product
                {
                    ...
                    StoreId = 3,
                    Url =
                        "https://www.bestbuy.ca/en-ca/product/custom-gigabyte-aorus-15-laptop-intel-i7-12700h-32gb-ram-4tb-pcie-ssd-nvidia-rtx-3070-ti-15-6-win-10-pro/15997948",
                    Price = 7287.15M,
                    PriceUnit = "$",
                    CategoryId = 8
                },
                ...
                new Product
                {
                    ...
                    CategoryId = 9,
                    ImagePath =
                        "https://media.cnn.com/api/v1/images/stellar/prod/230919073346-iphone-15-review-cnnu-1.jpg?c=16x9"
                },
                new Product
                {
                    Name =
                        "iPhone 15 Pro Max 256GB/512GB/1TB Dual eSIM 6.7\" Genuine LTPO Super Retina XDR OLED Face ID NFC A17Pro 8GB 98% New 5G Cell Phone",
                    //CreationDate = DateTime.Now,
                    CreatedBy = "admin",
                    Id = 10,
                    StoreId = 4,
                    ...
                    CategoryId = 9,
                    ImagePath =
                        "https://ae-pic-a1.aliexpress-media.com/kf/See613671846f48ccba7a890a8efbe7a05/iPhone-15-Pro-Max-256GB-512GB-1TB-Dual-eSIM-6-7-Genuine-LTPO-Super-Retina-XDR.jpg",
                },
                new Product
                {
                ...
                new Product
                {
                    ...
                    StoreId = 3,
                    Url =
                        "https://www.bestbuy.com/site/samsung-galaxy-s24-ultra-512gb-unlocked-titanium-black/6569875.p?skuId=6569875",
                    Price = 1091.99M,
                    PriceUnit = "$",
                    CategoryId = 9,
                    ImagePath =
                        "https://pisces.bbystatic.com/image2/BestBuy_US/images/products/6569/6569875_sd.jpg;maxHeight=640;maxWidth=550;format=webp"
                },
                new Product
                {
                    Name = "Samsung 24 Ultra",
                    ...
                    CategoryId = 9,
                    ImagePath =
                        "https://www.ooredoo.tn/Personal/9085-large_default/portable-samsung-galaxy-s24-ultra.jpg",
                }
            );
    }
}